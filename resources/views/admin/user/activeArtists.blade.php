                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="active-artist-tab" data-toggle="pill"
                                        href="#active-artist" role="tab" aria-controls="active-artist" aria-selected="true">
                                        <span class="fa fa-list"> </span> Active Artists</a>
                                </li>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="active-artist">

                                    <table id="activeArtists" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                @foreach ($activeArtists as $key => $value)
                                                    <tr id="tr{{ $value['id'] }}">
                                                        <td>{{ $offset+$key + 1 }}</td>
                                                            ...
                                                            <div class='dropdown'>
                                                                ...
                                                                <ul class='dropdown-menu dropdown-menu-right p-3'>
                                                                    ...
                                                                    <li><a href='#' class="text-secondary" data-toggle="modal"
                                                                            data-target="#deactivateArtistModal{{ $value['id'] }}">
                                                                            <span class="fas fa-times mr-2"></span> Block</a>
                                                                    </li>
                                                                    <li><a href='#' class="text-secondary" data-toggle="modal"
                                                                            data-target="#deleteArtistModal{{ $value['id'] }}">
                                                    ...
                                                    <div class="modal fade" tabindex="-1" role="dialog"
                                                        id="deactivateArtistModal{{ $value['id'] }}">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer float-right">
                                                                    <button class="btn btn-danger"
                                                                        onclick="deactivateArtist({{ $value['id'] }})">Block</button>
                                                    ...
                                                    <div class="modal fade" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer float-right">
                                                                    <button onclick="deleteArtist({{ $value['id'] }})"
                                    ...
                                    <div class="row d-flex justify-content-end">
                                        <nav aria-label="Page navigation">
                                            <ul class="pagination">
                                                ...
                                                @else
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ url('User/activeArtists/'.($offset-$limit).'/'.($pageNumber-1)) }}" aria-label="Previous">
                                                        <span aria-hidden="true">&laquo;</span>
                                                        <span class="sr-only">Previous</span>
                                                        </a>
                                                    </li>
                                                @endif
                                                @if ($pageNumber > 3)
                                                    <li class="page-item"><a class="page-link" href="{{ url('User/activeArtists/'.($offset-($limit*3)).'/'.($pageNumber-3)) }}">{{$pageNumber-3}}</a></li>
                                                @endif
                                                @if ($pageNumber > 2)
                                                    <li class="page-item"><a class="page-link" href="{{ url('User/activeArtists/'.($offset-($limit*2)).'/'.($pageNumber-2)) }}">{{$pageNumber-2}}</a></li>
                                                @endif
                                                @if ($pageNumber > 1)
                                                    <li class="page-item"><a class="page-link" href="{{ url('User/activeArtists/'.($offset-($limit)).'/'.($pageNumber-1)) }}">{{$pageNumber-1}}</a></li>
                                                @endif

                                                <li class="page-item active"> <a class="page-link" >{{$pageNumber}} <span class="sr-only">(current)</span></a></li>

                                                @if (($offset + $limit) < $totalActiveArtists)
                                                    <li class="page-item"><a class="page-link" href="{{ url('User/activeArtists/'.($offset+($limit)).'/'.($pageNumber+1)) }}">{{$pageNumber+1}}</a></li>
                                                @endif
                                                @if (($offset + (2*$limit)) < $totalActiveArtists)
                                                    <li class="page-item"><a class="page-link" href="{{ url('User/activeArtists/'.($offset+($limit*2)).'/'.($pageNumber+2)) }}">{{$pageNumber+2}}</a></li>
                                                @endif
                                                @if (($offset + (3*$limit)) < $totalActiveArtists)
                                                    <li class="page-item"><a class="page-link" href="{{ url('User/activeArtists/'.($offset+($limit*3)).'/'.($pageNumber+3)) }}">{{$pageNumber+3}}</a></li>
                                                @endif

                                                @if ((($offset+$limit) == $totalActiveArtists) || (($offset+$limit) > $totalActiveArtists))
                                                    <li class="page-item disabled">
                                                        <a class="page-link" href="#" tabindex="-1">
                                                ...
                                                @else
                                                    <li class="page-item">
                                                        <a class="page-link" href="{{ url('User/activeArtists/'.($offset+$limit).'/'.($pageNumber+1)) }}" aria-label="Next">
                                                        <span aria-hidden="true">&raquo;</span>
                                                        <span class="sr-only">Next</span>
                                                        </a>
                                                  </li>
        ...
        function deactivateArtist(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        $('#deactivateArtistModal' + id).modal('hide');

            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary card-outline card-outline-tabs">
                    <div class="card-header p-2">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" id="active-admin-tab" data-toggle="pill" href="#active-admin" role="tab" aria-controls="active-admin" aria-selected="true"> <span class="fa fa-list"> </span> Active Admins</a>
                        </li>
                    ...
                    <div class="card-body">
                      <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="active-admin">

                            <table id="activeAdmins" class="table table-bordered table-striped">

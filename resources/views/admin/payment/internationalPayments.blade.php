                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="notPayedPayment-tab" data-toggle="pill"
                                        href="#notPayedPayment" role="tab" aria-controls="notPayedPayment"
                                        aria-selected="true"> <span class="fa fa-list"> </span> International Payment(Not
                                        Payed)</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" id="payedPayment-tab" data-toggle="pill" href="#payedPayment"
                                        role="tab" aria-controls="payedPayment" aria-selected="true"> <span
                                            class="fa fa-list"> </span> International Payment(Payed)</a>
                                </li>
...
@section('scriptSection')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $.ajax({
                url: "{{ url('payments/internationalPaymentsNotPayed/0') }}",
                type: 'get',
            ...
            $.ajax({
                url: "{{ url('payments/internationalPaymentsPayed/0') }}",
                type: 'get',
                success: function(data) {
        ...
        function loadMoreInternationalNotPayed(offsetVal, pageNumberVal) {
            $('#not_payed_table_data').html(loading);
            $.ajax({
                url: "{{ url('payments/internationalPaymentsNotPayed/') }}" + '/' + offsetVal + '/' + pageNumberVal,
                type: 'get',
                success: function(data) {
                    $('#not_payed_table_data').html(data);
                    $('#internationalPaymentNotPayed').DataTable({
        ...
        function loadMoreInternationalPayed(offsetVal, pageNumberVal) {
            $('#payed_table_data').html(loading);
            $.ajax({
                url: "{{ url('payments/internationalPaymentsPayed/') }}" + '/' + offsetVal + '/' + pageNumberVal,
                type: 'get',
                success: function(data) {
                    $('#payed_table_data').html(data);
                    $('#internationalPaymentPayed').DataTable({
        ...
        function searchForINotPayed(searchInput) {
            if (searchInput != "") {
                ...
                $('#not_payed_table_data').html(loading);
                $.ajax({
                    url: "{{ url('payments/searchINotPayed') }}" + '/' + searchInput,
                    type: 'get',
                    success: function(data) {
                        $('#not_payed_table_data').html(data);
        ...
        function searchForIPayed(searchInput) {
            if (searchInput != "") {
                ...
                $.ajax({
                    url: "{{ url('payments/searchIPayed') }}" + '/' + searchInput,
                    type: 'get',
                    success: function(data) {
                        $('#payed_table_data').html(data);

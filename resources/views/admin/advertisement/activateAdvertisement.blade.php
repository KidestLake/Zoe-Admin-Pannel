                    ...
                    <div class="card card-primary card-outline card-outline-tabs">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="activate-advertisement-tab" data-toggle="pill"
                                        href="#activate-advertisement" role="tab" aria-controls="activate-advertisement"
                                        aria-selected="true"> <span class="fas fa-retweet"> </span> Activate Advertisement</a>
                                </li>
                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="activate-advertisement">
                                       ...
                                       <div class="form-group row">
                                           ...
                                           <div class="col-sm-10">
                                               <input type="text" class="form-control" id="owner_name"
                                                   name="owner_name" value="{{ $advertisement['owner_name'] }}">
                                           </div>
                                       </div>
                                       <div class="form-group row">

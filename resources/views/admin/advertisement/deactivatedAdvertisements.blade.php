                        ...
                        <div class='dropdown'>
                            ...
                            <ul class='dropdown-menu dropdown-menu-right p-3'>
                                ...
                                <li><a href="JavaScript:void(0);" class="text-secondary"
                                    onclick="activateAdvertisementPage({{ $value['id'] }})">
            ...
            <ul class="pagination">
                ...
                @else
                    <li class="page-item">
                        <a class="page-link" href="JavaScript:void(0);"
                            onclick="loadMoreDeactivatedAdvertisements({{ $offset - $limit }},{{ $pageNumber - 1 }})"
                            aria-label="Previous">
                            <span aria-hidden="true">&laquo;</span>
                            <span class="sr-only">Previous</span>
                        </a>
                ...
                @if ($pageNumber > 3)
                    <li class="page-item"><a class="page-link" href="JavaScript:void(0);"
                            onclick="loadMoreDeactivatedAdvertisements({{ $offset - $limit * 3 }},{{ $pageNumber - 3 }})">{{ $pageNumber - 3 }}</a>
                    </li>
                @endif
                @if ($pageNumber > 2)
                    <li class="page-item"><a class="page-link" href="JavaScript:void(0);"
                            onclick="loadMoreDeactivatedAdvertisements({{ $offset - $limit * 2 }},{{ $pageNumber - 2 }})">{{ $pageNumber - 2 }}</a>
                    </li>
                @endif
                @if ($pageNumber > 1)
                    <li class="page-item"><a class="page-link" href="JavaScript:void(0);"
                            onclick="loadMoreDeactivatedAdvertisements({{ $offset - $limit }},{{ $pageNumber - 1 }})">{{ $pageNumber - 1 }}</a>
                    </li>
                @endif
                ...
                @if ($offset + 2 * $limit < $totalAd)
                    <li class="page-item"><a class="page-link" href="JavaScript:void(0);"
                            onclick="loadMoreActiveAdvertisements({{ $offset + $limit * 2 }},{{ $pageNumber + 2 }})">{{ $pageNumber + 2 }}</a>
                    </li>
                @endif

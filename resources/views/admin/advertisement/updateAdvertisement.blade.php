...
<form role="form" method="post" class="form-horizontal form-group"
    action="{{ url('advertisements/update/' . $advertisement['id']) }}" enctype="multipart/form-data"
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="owner_name" name="owner_name"
                    value="{{ $advertisement['owner_name'] }}" autofocus>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            <label for="bannerImage" class="col-sm-2 col-form-label">Smaller
                Banner</label>
            <div class="col-sm-8">
                <input type="file" class="form-control" id="edit_banner_image_one" name="banner_image_one"
                    accept="image/*">
            </div>
        ...
        <div class="form-group row">
            <label for="bannerImage" class="col-sm-2 col-form-label">Larger
                Banner</label>
            <div class="col-sm-8">
                <input type="file" class="form-control" id="edit_banner_image_two" name="banner_image_two"
                    accept="image/*">
            </div>
            <div class="offset-sm-2">
